...
void DoInstall (void *arg)
{
	...
	if (bUpgrade
		&& (IsFileInUse (string (InstallationPath) + '\\' + TC_APP_NAME ".exe")
			...
			|| IsFileInUse (string (InstallationPath) + '\\' + TC_APP_NAME_LEGACY ".exe")
			|| IsFileInUse (string (InstallationPath) + '\\' + TC_APP_NAME_LEGACY " Format.exe")
			|| IsFileInUse (string (InstallationPath) + '\\' + TC_APP_NAME_LEGACY " Setup.exe")
			)
		)
	{
		NormalCursor ();
