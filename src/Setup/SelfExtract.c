...
{
	MessageBox (NULL, msg, "CipherShed", MB_ICONERROR | MB_SETFOREGROUND | MB_TOPMOST);
}


static void PkgWarning (char *msg)
{
	MessageBox (NULL, msg, "CipherShed", MB_ICONWARNING | MB_SETFOREGROUND | MB_TOPMOST);
}


static void PkgInfo (char *msg)
{
	MessageBox (NULL, msg, "CipherShed", MB_ICONINFORMATION | MB_SETFOREGROUND | MB_TOPMOST);
}
