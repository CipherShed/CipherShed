...
namespace CipherShed
{
	...
	std::wstring GetFavoriteVolumeLabel (const std::string &volumePath);
	...
	static bool SaveFavoriteVolumes (const std::vector <FavoriteVolume> &favorites, bool systemFavorites);
